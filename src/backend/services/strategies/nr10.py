...
from backend.domain.models.nr10 import NR10Data


class NR10ExtractionStrategy(DocumentExtractionStrategy):
    """Concrete strategy for extracting structured data from a NR-10 certificate."""

    document_type: DocumentType = DocumentType.NR10

    SYSTEM_PROMPT: str = (
        "You are a document analysis specialist for Brazilian documents. "
        "You are receiving an image or PDF of a NR-10 training certificate.\n\n"
