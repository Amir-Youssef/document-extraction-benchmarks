...
from backend.domain.models.nr35 import NR35Data


class NR35ExtractionStrategy(DocumentExtractionStrategy):
    """Concrete strategy for extracting structured data from a NR-35 training certificate."""

    document_type: DocumentType = DocumentType.NR35

    SYSTEM_PROMPT: str = (
        "You are a document analysis specialist for Brazilian documents. "
        "You are receiving an image or PDF of a NR-35 training certificate.\n\n"
        ...
        "- treinamento: name of the training exactly as printed in the document.\n"
        "- data: training date in YYYY-MM-DD format.\n"
