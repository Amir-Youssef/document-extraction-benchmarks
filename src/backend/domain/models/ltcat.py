...
class LTCATData(BaseModel):
    """Structured data extracted from a Brazilian LTCAT document."""
    ...
    autor: str = Field(
        description="Name of the responsible technical author or signing professional exactly as printed.",
    )